function UpdateTime(){
    ...
    timeText.innerHTML = currentTime + " am";
}
setInterval(UpdateTime, 1000);

var currentDate = new Date().toLocaleDateString([], { weekday: 'short',day: 'numeric' , month: 'short',  year: 'numeric'});
...
var closeButton = document.getElementById("clos");
...
var minimizeButton = document.getElementById("min");
